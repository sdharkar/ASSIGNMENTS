...
public class Assignment1Q9 {
	    ...
	    public static void main(String[] args) {
	        ...
	        try (Scanner sc = new Scanner(System.in)) {
	            ...
	            System.out.println("Total marks of all the students in all subjects: " + studentsTotalMarksInAllSubjects(marks));

	            System.out.println("Average marks of all the students in all subjects: " + studentsAverageMarksInAllSubjects(marks));

	            System.out.println("Total marks scored by students in subject A: " + subjectATotalByStudents(marks));
	            System.out.println("Average marks scored by students in subject A: " + subjectAAverageByStudents(marks));

	            System.out.println("Total marks scored by students in subject B: " + subjectBTotalByStudents(marks));
	            System.out.println("Average marks scored by students in subject B: " + subjectBAverageByStudents(marks));

	            System.out.println("Total marks scored by students in subject C: " + subjectCTotalByStudents(marks));
	            System.out.println("Average marks scored by students in subject C: " + subjectCAverageByStudents(marks));
	        }
